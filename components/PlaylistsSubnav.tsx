...
export function PlaylistsSubnav() {
  ...
  return (
    <nav
      ...
      className="flex w-full max-w-md flex-wrap gap-1 rounded-xl border border-white/[0.08] bg-white/[0.04] p-1 sm:inline-flex sm:max-w-none"
    >
      <Link
        href="/playlists"
        className={cn(
          ...
          isWamPlaylists
            ? "bg-wam/15 text-wam shadow-sm shadow-wam/10"
